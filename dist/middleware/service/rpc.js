...
export class RPC {
    ...
    manifest;
    io;
    constructor(config, orbitdb, manifest) {
        this.config = config;
    ...
    async refresh(newAddrs, removedAddrs) {
